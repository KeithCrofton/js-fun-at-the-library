...
var title = "The Old Man and The Sea";
var pages = 420;
...
function timeToRead(pages){
  if(pages < 1000){
    return("I could read that in a day!")
  } else {return("Ok, maybe I could read that in a day and a half")
}
}
...
var belowTwoHundred = [190, 180, 170, 160, 150, 140, 130, 120, 110, 100, 90, 80,];
